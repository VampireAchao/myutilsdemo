...
public class Encrypt {
     ...
     * 即如果直接对密码进行散列S相H对O来P说X破5解更容易，此时我们可以加一些只有系统知道的干扰数据，
    ...
    public static void main(String[] args) {
        //System.out.println(new Md5Hash("123456","tanglijing02",2).toString());
        System.out.println(new Md5Hash("123456", "shopx5", 2).toString());
    }
