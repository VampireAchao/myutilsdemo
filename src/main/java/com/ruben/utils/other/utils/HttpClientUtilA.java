...
public class HttpClientUtilA {
    ...
    private static HttpClientUtilA instance = null;

    private HttpClientUtilA() {
    }

    public static HttpClientUtilA getInstance() {
        if (instance == null) {
            instance = new HttpClientUtilA();
        }
        return instance;
    }
