 ...
 * 日期工具类
 */
public class DateUtilsA extends org.apache.commons.lang.time.DateUtils {
    ...
    private static final Logger logger = Logger.getLogger(DateUtilsA.class);
    ...
    public static SimpleDateFormat sdfDateTime = new SimpleDateFormat(DateUtilsA.DATE_FORMAT_DATETIME);
    // Global SimpleDateFormat object
    public static SimpleDateFormat sdfDateOnly = new SimpleDateFormat(DateUtilsA.DATE_FORMAT_DATEONLY);
    ...
    public static Timestamp toSqlTimestamp(String sDate) {
        ...
        if (sDate.length() != DateUtilsA.DATE_FORMAT_DATEONLY.length()
                && sDate.length() != DateUtilsA.DATE_FORMAT_DATETIME.length()) {
            return null;
        }
        return toSqlTimestamp(sDate,
                sDate.length() == DateUtilsA.DATE_FORMAT_DATEONLY.length()
                        ? DateUtilsA.DATE_FORMAT_DATEONLY
                        : DateUtilsA.DATE_FORMAT_DATETIME);
    ...
    public static Timestamp toSqlTimestamp(String sDate, String sFmt) {
        ...
        if (sFmt.equals(DateUtilsA.DATE_FORMAT_DATETIME)) {
            temp = sDate.replace('/', '-');
            temp = temp + ".000000000";
        } else if (sFmt.equals(DateUtilsA.DATE_FORMAT_DATEONLY)) {
            temp = sDate.replace('/', '-');
    ...
    public static String getSysDateTimeString() {
        return toString(new Date(System.currentTimeMillis()), DateUtilsA.sdfDateTime);
    }
    ...
    public static String toSqlTimestampString2(Timestamp dt) {
        ...
        String temp = toSqlTimestampString(dt, DateUtilsA.DATE_FORMAT_DATETIME);
    ...
    public static String toSqlTimestampString(Timestamp dt, String sFmt) {
        ...
        temp = dt.toString();
        if (sFmt.equals(DateUtilsA.DATE_FORMAT_DATETIME) || // "YYYY/MM/DD
                // HH24:MI:SS"
                sFmt.equals(DateUtilsA.DATE_FORMAT_DATEONLY)) { // YYYY/MM/DD
    ...
    public static String timestampToStringYMD(Timestamp timestamp) {
        SimpleDateFormat sdf = new SimpleDateFormat(DateUtilsA.DATE_FORMAT_DATEONLY);
    ...
    public static boolean isOverIntervalLimit(String startDateStr, String endDateStr, int interval) {
        Date startDate = null;
        Date endDate = null;
        startDate = DateUtilsA.parseDate(startDateStr, DateUtilsA.DATE_FORMAT_DATEONLY);
        endDate = DateUtilsA.parseDate(endDateStr, DateUtilsA.DATE_FORMAT_DATEONLY);
    ...
    public static Date getMinTime(Date dt) {
        Date dt1 = null;
        dt1 = DateUtilsA.getDateByStr(DateUtilsA.formatDate(dt, "yyyy-MM-dd"));
        return dt1;
    }
    ...
    public static List<String> getLastDays(int countDay) {
        ...
        for (int i = 0; i < countDay; i++) {
            listDate.add(DateUtilsA.getReqDateyyyyMMdd(DateUtilsA.getDate(-i)));
        }
        return listDate;
    }
